package com.feicui.demo.videoplayer.part;
...
public class SimplevideoPlayer extends FrameLayout {
    ...
    private ImageButton btnToggle;//播放和暂停
    ...
    private void initSurfaceView() {
        ...
        //注意，vitamio使用surfaceview要设置fixelFormat
